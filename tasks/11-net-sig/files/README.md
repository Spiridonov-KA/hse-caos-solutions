...
с индексом x. Например, сигнал SIGRTMIN + 2 переключает программу в режим чтения из файла с индексом 2,
...
Поступившие сигналы должны быть обработаны сразу, дожидаться окончания текущего файла не нужно.
