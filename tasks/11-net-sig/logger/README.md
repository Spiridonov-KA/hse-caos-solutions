...
Напишите логгер в файле [logger.cpp](./logger.cpp), принимающий на заданном порту датаграммы UDP/IPv6 с произвольных адресов
...
> [!note]
>
> Обратите внимание на то, что тесты полагаются на наличие некоторых стандартных
> утилит в вашей системе
