...
На почту в домене `edu.hse.ru` вы должны были получить логин и пароль от [gitlab.hse-caos.org](https://gitlab.hse-caos.org), там будет храниться ваш репозиторий с решениями, а так же будет происходить тестирование домашних заданий.
